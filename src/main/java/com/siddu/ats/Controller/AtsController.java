...
//    @PostMapping("/Ats/resume/AtsAnalysis")
//    public ResponseEntity<ATSAnalysis> uploadResume(
//            @RequestParam("file") MultipartFile file) throws IOException, TikaException {
//         return ResponseEntity.ok(resumeAnalysisService.analyze(resumeExtractor.extractText(file)));
//    }
...
//    @PostMapping("/Ats/resume/job-match-Analysis")
//    public ResponseEntity<JobMatchAnalysis> uploadJobMatchAnalysis(
//            @RequestPart("file") MultipartFile file, @RequestPart("jobDescription") Jobdescription jobDescription) throws IOException, TikaException{
//        return ResponseEntity.ok(jobMatchAnalysisService.analyze(resumeExtractor.extractText(file),jobDescription.getDescription()));
//
//    }



//    @PostMapping("/Ats/resume/mcq-test")
//    public ResponseEntity<McqTestDto> uploadMcqTest(
//            @RequestPart("file") MultipartFile file) throws IOException, TikaException{
//        return ResponseEntity.ok(mcqTestgenerateService.analyze(resumeExtractor.extractText(file)));
//
//    }
